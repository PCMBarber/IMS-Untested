...
public class OrderDAOTestFail {
	...
	public void testCreate() {
		final Order created = new Order(4L, new Customer(3L, "piers", "barber"), new ArrayList<>());
	...
	public void testUpdate() {
		final Order updated = new Order(4L, new Customer(3L, "piers", "barber"), new ArrayList<>());

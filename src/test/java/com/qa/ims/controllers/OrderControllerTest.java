...
public class OrderControllerTest {
	...
	public void testCreate() {
		...
		Order expected = new Order(3l,customer,items);
		...
		when(orderDAO.create(any(Order.class))).thenReturn(new Order(3l,customer,new ArrayList<>()));
	...
	public void testReadAll() {
		...
		List<Item> items = new ArrayList<>();
		Customer customer = new Customer(3L, "Piers", "Barber");
		Order order1 = new Order(3l,customer,items);
		Order order2 = new Order(3l,customer,items);
	...
	public void testUpdate() {
		...
		Item wheelieBin = new Item(itemID, "wheelie bin", 3.99, 84528L);
		Order current = new Order(orderID,customer,items);
